...
6. **Structure your response** using clear markdown sections with complete evidence and actionable recommendations
...
**Workflow Recommendation**: Streamlined/Comprehensive investigation approach
...
- **Recommendation** (Priority: Medium, Effort: LOW/MEDIUM/HIGH):
  - Action: Supporting action for comprehensive resolution
  - Rationale: Why this complements the primary recommendation

#### Investigation Areas

- **High Priority**: Additional investigation needed by development team
- **Medium Priority**: Secondary investigation areas for comprehensive understanding

### Quality Validation

- **Evidence Completeness**: Confirmation that analysis is backed by concrete evidence
- **Actionability Check**: Verification that recommendations are specific and implementable
- **Architectural Consistency**: Confirmation that solutions align with project patterns

## Complexity Classification Protocol

Execute this exact classification sequence:

**SIMPLE** (< 1 day): Single file changes, configuration updates, content modifications, simple UI adjustments, multi-file components with clear patterns
...
**COMPLEX** (1+ days): Architecture changes, system integrations, performance optimizations, security implementations, new features requiring integration across multiple components
